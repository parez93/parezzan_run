            ...
            <div className="container mx-auto">
                <div className="flex flex-col md:flex-row justify-between items-center mb-8">
                    <div className="mb-6 md:mb-0">
                        <h3 className="text-xl font-bold mb-2">Federico Parezzan<span
                            className="text-runner-orange">.Run</span></h3>
                        <p className="text-gray-300 text-sm max-w-xs">Dedicato alla mia passione per la corsa e al mio
                            viaggio di trasformazione personale</p>
                    </div>

                    <div className="flex space-x-4">
                        <Button variant="ghost" size="icon"
                                className="rounded-full text-white hover:bg-white/10 hover:text-runner-orange"
                                onClick={() => window.open('https://www.instagram.com/thewingedrunner/', '_blank')}>
...
{/*                        <Button variant="ghost" size="icon"
                        ...
                        <>
                            ...
                            <Button variant="ghost" size="icon"
                                    className="rounded-full text-white hover:bg-white/10 hover:text-runner-orange"
                                    onClick={() => window.open('https://strava.com/athletes/70185070', '_blank')}>

                            <a
                                href="https://strava.com/athletes/70185070"
