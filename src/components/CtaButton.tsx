    ...
    return (
        <div className="py-16 px-4 text-center relative">
            ...
            <div className="max-w-2xl mx-auto">
                <h2 className="text-2xl md:text-3xl font-bold mb-6 text-runner-dark-blue">Unisciti alla mia avventura di corsa</h2>
                <p className="text-gray-600 mb-8">Segui i miei progressi, scopri i miei percorsi preferiti e condividi la passione per la corsa</p>
                <Button
